...
request with just the failing test case(you can find some example test file like [session_get_test.go](https://github.com/lklcdu2010/xorm/blob/master/session_get_test.go)).

If you implements a new database interface, you maybe need to add a test\_<databasename>.sh file.
For example, [mysql_test.go](https://github.com/lklcdu2010/xorm/blob/master/test_mysql.sh)
